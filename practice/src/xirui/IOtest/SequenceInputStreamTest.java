...
public class SequenceInputStreamTest {
    ...
    private static void doSequence() {
        ...
        try {
            ...
            vector.addElement(new FileInputStream("C:/Users/Xirui/Desktop/BS权限管理需求.doc"));
            vector.addElement(new FileInputStream("C:/Users/Xirui/Desktop/BS权限管理设计.doc"));
            //vector.addElement(new FileInputStream("D:\text3.txt"));
            Enumeration<InputStream> e = vector.elements();

            sis = new SequenceInputStream(e);

            bos = new BufferedOutputStream(new FileOutputStream("C:/Users/Xirui/Desktop/1.doc"));
            // 读写数据
