...
public class BinaryTree {
    ...
    public static void main(String[] args) {
        ...
        while (in.hasNextInt()) {
            Btree.buildTree(Btree.root,in.nextInt());
        }
        System.out.println(Btree.getDepthRec(Btree.root));
        Btree.inorderTraversalRec(Btree.root);
        System.out.println();
     ...
     *  递归转换BST为双向链表(DLL)
     */
    public  TreeNode convertBST2DLLSubRec(TreeNode root){
    ...
    public  TreeNode getLastCommonParentRec2(TreeNode root, TreeNode n1, TreeNode n2) {
        if(root == null){
            return null;
        }
